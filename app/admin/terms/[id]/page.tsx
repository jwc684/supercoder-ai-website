...
export default async function AdminTermsEditPage({
  params,
}: {
    ...
    <div className="px-6 py-8 md:px-10 md:py-10">
      ...
      <div className="mt-6">
        <TermsEditorForm
          mode="edit"
          termsId={terms.id}
          initialIsActive={terms.isActive}
          initial={{
            title: terms.title,
            type: terms.type,
            version: terms.version,
            effectiveDate: toLocalInput(terms.effectiveDate),
            content: terms.content as RichEditorContent,
          }}
        />
      </div>
    </div>
