        ...
        <AnomalousMatterHero
          ...
          title={
            <>
              좋은 인재,
              <br />
              <span className="text-sky-300">직감 말고 데이터로</span>
            </>
          }
          description={
            <>
        ...
        >
          <div className="flex flex-wrap items-center justify-center gap-3">
            <Link
              ...
              className="inline-flex items-center justify-center gap-2 rounded-lg bg-white px-8 py-4 text-base font-semibold leading-[1.5] text-black transition-colors hover:bg-white/90"
            >
              무료 데모 신청하기 →
            </Link>
            <Link
              ...
              className="inline-flex items-center justify-center gap-2 rounded-lg bg-transparent px-8 py-4 text-base font-semibold leading-[1.5] text-white shadow-[inset_0_0_0_1px_rgba(255,255,255,0.4)] transition-colors hover:bg-white/10 hover:shadow-[inset_0_0_0_1px_rgba(255,255,255,0.7)]"
            >
              소개서 다운로드
            </Link>
          </div>
